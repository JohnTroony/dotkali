...
CFLAGS   := -c -Wall -g -O2 -fdebug-prefix-map=/root/dotkali/src/fontinstall/freetype-infinality/freetype-2.4.9=. -fstack-protector-strong -Wformat -Werror=format-security -D_GNU_SOURCE=1 -D_GNU_SOURCE=1 -DFT_CONFIG_OPTION_SYSTEM_ZLIB -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
